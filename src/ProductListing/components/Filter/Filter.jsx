          ...
          <div className="price-container">
            ...
            <div className="price-input-container">
              ...
              <label htmlFor="201-999">
                ...
                <input
                  checked={state.filters.price.find((price) =>
                    price.min === 16100 ? true : false
                  )}
                  onChange={() =>
                    dispatch({
                      type: "ADD_PRICE",
                      payload: { min: 16100, max: 80900 },
                    })
                  }
                  id="201-999"
                  type="checkbox"
              ...
              <label htmlFor="1000-1999">
                ...
                <input
                  checked={state.filters.price.find((price) =>
                    price.min === 81000 ? true : false
                  )}
                  onChange={() =>
                    dispatch({
                      type: "ADD_PRICE",
                      payload: { min: 81000, max: 161000 },
                    })
                  }
                  id="1000-1999"
                  type="checkbox"
              ...
              <label htmlFor="above 2000">
                ...
                <input
                  checked={state.filters.price.find((price) =>
                    price.min === 162000 ? true : false
                  )}
                  onChange={() =>
                    dispatch({
                      type: "ADD_PRICE",
                      payload: { min: 162000, max: 405000 },
                    })
                  }
                  id="above 2000"
                  type="checkbox"
